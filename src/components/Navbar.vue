<template>
  <nav class="navbar">
    <RouterLink class="brand flex flex-row items-center no-underline!" to="/">
      <img src="/images/logo.jpg" class="h-14 w-auto" />
      <div class="flex flex-col">
        <p class="f-amaranth text-xl font-medium text-primary">Lifelines Canada</p>
    ...
    <div class="nav-links" :class="{ active: menuOpen }" ref="navLinks">
      ...
      <a href="https://www.google.com" class="underline ms-auto xl:ms-0">Leave site</a>
    </div>
  </nav>
</template>
